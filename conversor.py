...
from pegar_moedas import nomes_moedas, dic_conversoes_disponiveis
...
texto_da_moeda_de_origem = customtkinter.CTkLabel(janela, text = "Selecione a moeda de origem")
texto_da_moeda_de_destino = customtkinter.CTkLabel(janela, text = "Selecione a moeda de destino")

def carregar_moedas_destino(moeda_selecionada):
    lista_moedas_destino = conversoes_diponiveis[moeda_selecionada]
    campo_moeda_destino.configure(values=lista_moedas_destino)
    campo_moeda_destino.set(lista_moedas_destino[0])


campo_moeda_origem = customtkinter.CTkOptionMenu(janela, values=list(conversoes_diponiveis.keys()), 
...
for codigo_moeda in moedas_disponiveis:
    ...
    texto_moeda = customtkinter.CTkLabel(listas_moedas, text =f"{codigo_moeda}: {nomes_moedas}")
    texto_moeda.pack()



# Colocar todos os elemntos na Tela 
titulo.pack(padx=10, pady=10)
texto_da_moeda_de_origem.pack(padx=10)
campo_moeda_origem.pack(padx=10, pady=10)
texto_da_moeda_de_destino.pack(padx=10)
